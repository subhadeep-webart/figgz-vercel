        ...
        <TableWrapper>
            ...
            <tbody>
                <tr className="text-product-text-info [&>td]:!py-4 [&>td]:!px-6 [&>td]:text-left [&>td]:font-normal [&>td]:text-lg">
                    ...
                    <td>24 April 2025</td>
                    <td>
                        <CustomChip className="text-success border-1 border-success" variant="bordered">
                            Paid
                        </CustomChip>
                    </td>
                </tr>
                 <tr className="text-product-text-info [&>td]:!py-4 [&>td]:!px-6 [&>td]:text-left [&>td]:font-normal [&>td]:text-lg">
                    ...
                    <td>24 April 2025</td>
                    <td>
                        <CustomChip className="text-danger border-1 border-danger" variant="bordered">
                            Cancelled
                        </CustomChip>
                    </td>
                </tr>
                  <tr className="text-product-text-info [&>td]:!py-4 [&>td]:!px-6 [&>td]:text-left [&>td]:font-normal [&>td]:text-lg">
                    ...
                    <td>24 April 2025</td>
                    <td>
                        <CustomChip className="text-warning border-1 border-warning" variant="bordered">
                            Pending
                        </CustomChip>
                    </td>
                </tr>
