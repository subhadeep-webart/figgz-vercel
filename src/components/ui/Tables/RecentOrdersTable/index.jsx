...
import { TableBody, TableCell, TableRow } from "@heroui/react";

const RecentOrderTable = ({ label, columns, items, renderCell }) => {
  ...
  return (
    <VendorTableWrapper columns={columns} label={label}>
      <TableBody
        // items={[
