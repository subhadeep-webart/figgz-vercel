            ...
            <div className="flex gap-5">
                ...
                <div className="w-full !space-y-1">
                    <div className="flex justify-between items-center">
                        <CustomChip className={"border-1 border-border-top-product-chip"}>
                            <p className="text-sm text-invoice-date">In Stock: <span className="text-top-product-chip">25 pieces</span></p>
                        </CustomChip>
