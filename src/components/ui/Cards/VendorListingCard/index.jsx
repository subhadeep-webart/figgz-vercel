    ...
    return(
        <>
         <Link href={"/seller-profile"} className="w-64 h-60 flex flex-col gap-3">
            <ImageWrapper className={"border-1 border-border-category w-64 h-60 rounded-3xl"}>
            ...
            <p className="text-foreground text-xl font-semibold text-left">{categoryName}</p>
        </Link>
        </>
    )
};
