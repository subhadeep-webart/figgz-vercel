...
const FashionCard = () => {
    return (
        <Link href={"#"} className="flex flex-col gap-5 h-64 w-48 space-y-3">
            <ImageWrapper className={"h-56 w-48 rounded-3xl"}>
            ...
            <p className="text-foreground text-base font-semibold text-left px-2">Tops</p>
        </Link>
    )
}
