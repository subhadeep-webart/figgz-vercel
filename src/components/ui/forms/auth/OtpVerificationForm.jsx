  ...
  return (
    <>
      <div className={styles.login_form_container}>
        <div className="w-16 h-16 bg-bg-otp-icon rounded-full hidden sm:flex items-center justify-center">
          <Icons.MailIcon fill="#1249D2" size={28} />
        </div>

        <h1 className="text-foreground font-bold text-sm md:text-3xl text-center">
          OTP Verification
        </h1>
        <h2 className="text-text-info font-normal text-xs md:text-sm text-center">
          One Time Password (OTP) has been sent via Email to{" "}
          <span className="font-semibold">hellosmith*****@gmail.com</span>
        </h2>
        <p className="text-text-otp font-normal text-xs md:text-sm">
          Enter the OTP below to verify it.
        </p>
        <OtpInput />
        <p className="text-text-otp-resend text-xs md:text-sm">
