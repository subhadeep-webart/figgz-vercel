  ...
  return (
    ...
    >
      ...
      {showDealsAndOfferInfo && (
        <div className="flex">
          <h4 className="font-normal text-lg text-deals-offer-text-2 rotate-90 origin-center -translate-x-16 -translate-y-14">SAVE UP TO<span className="font-bold text-[28px] text-deals-offer-text-3">70%</span></h4>
          <div className="max-w-[446px] w-full">
            <h1 className="font-normal text-[43px] text-product-text-base">
              Deals Ending Soon <span className="font-bold">–</span>{" "}
              <span className="font-bold text-secondary">Grab Now!</span>
            </h1>
            <p className="font-medium text-sm !mb-12 text-deals-offer-text">
              Join thousands of businesses selling on Figgz. Reach millions of
              customers and grow your business globally.
            </p>
            <CustomButton className="h-[52px] text-[#000000] font-medium text-sm !px-14">
              Explore Products
            </CustomButton>
          </div>
        </div>
