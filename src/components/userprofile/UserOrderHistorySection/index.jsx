...
import MobileOrderHistoryCard from "./MobileOrderHistoryCard";
  ...
  return (
    <TableWrapper>
                ...
                <div className="flex flex-col gap-1">
                  <div className="flex justify-between">
                    <p className="font-medium text-lg text-product-text-base">
                      adidas Terrex AX4 Mid Gore-TEX Hiking Shoes Women’s,
                      Black, Size 8
                    </p>
              ...
              <div className="flex justify-between items-center">
                ...
                >
                  <div className="flex items-center justify-center">
                    <Icons.DeliveryParcelIcon size={22} color="#EC9C00" /> On
                    The Way
                  </div>
                </CustomChip>
              </div>
      ...
      <div className="md:hidden !space-y-4">
        <h3 className="text-base font-bold text-foreground !ml-1">My Order</h3>
