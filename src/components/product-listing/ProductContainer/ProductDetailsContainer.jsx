    ...
    return (
        <div className="flex flex-col gap-1.5 w-full h-36 justify-center items-start !px-1.5">
            <div className="flex items-start justify-between">
                <span className="font-medium text-[10px] md:text-xs text-foreground inline-block">Abstract Printed Polo Collar Pure Cotton Shirt</span>
            ...
            <div className="flex justify-center items-start gap-2.5">
                ...
                <span className="font-bold text-[10px] md:text-sm text-green-default">57%</span>
            </div>
            <div className="flex justify-start items-center gap-1">
                <Icons.DeliveryIcon /><span className="inline-block text-[10px] md:text-lg font-normal text-gray-default">Free Delivery</span>
            </div>
        </div>
    )
}
